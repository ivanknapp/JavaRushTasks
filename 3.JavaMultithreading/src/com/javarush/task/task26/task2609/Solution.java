...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.hash(key));
        System.out.println(solution.hash(key1));
        System.out.println(solution.hash(key2));
        System.out.println(solution.hash(key3));
        System.out.println(solution.hash(key4));
        System.out.println(solution.hash(key5));
        System.out.println(solution.hash(key6));
