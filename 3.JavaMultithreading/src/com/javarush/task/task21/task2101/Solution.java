...
public class Solution {
    ...
    public static void print(byte[] bytes) {
        for (byte b :bytes) {
            ...
            System.out.print((b & 0b00010000) != 0 ? 1 : 0);
            System.out.print((b & 0b00001000) != 0 ? 1 : 0);
            System.out.print((b & 0b00000100) != 0 ? 1 : 0);
            System.out.print((b & 0b00000010) != 0 ? 1 : 0);
            System.out.print((b & 0b00000001) != 0 ? 1 : 0);
            System.out.print(" ");
        }
        System.out.println();
    }
